...
class Order(models.Model):
    ...
    confirmation_sent = models.BooleanField(default=False, verbose_name="Potvrzeni zaslane")
    shipped_sent = models.BooleanField(default=False, verbose_name="Predano dopravci")
