    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "konfekcni_velikost",
                    models.CharField(
                        help_text="Dostupné konfekční velikosti", max_length=20
                    ),
                ),
                ("velikost_na_miru", models.PositiveIntegerField()),
            ],
        ),
        migrations.CreateModel(
            name="ObvodPrsa",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "obvod_hrudnik",
                    models.ManyToManyField(blank=True, to="catalog.obvodhrudnik"),
                ),
                (
                    "obvod_prsa",
                    models.ManyToManyField(blank=True, to="catalog.obvodprsa"),
                ),
            ],
            options={
                "ordering": ["name"],
